...
- Generated output stays out of Git: `dist/`, `.ssr/`, and `.trebired/code-discipline/generated/`. A fresh clone must run `bunx code-discipline fix imports` once to write `.trebired/code-discipline/generated/tsconfig.paths.json`, or `tsc` cannot resolve the alias imports.
